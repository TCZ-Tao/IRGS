...
CUDA_VISIBLE_DEVICES=0 python train_refgaussian.py \
    -s /ssd2/tcz/data/my/dining_chair \
    -m outputs/dining_chair/refgs \
    --eval -w --lambda_mask_entropy 0.05

CUDA_VISIBLE_DEVICES=0 python train.py \
    -s /ssd2/tcz/data/my/dining_chair \
    --eval --iterations 20000 \
    --start_checkpoint_refgs outputs/dining_chair/refgs/chkpnt50000.pth \
    ...
    --lambda_light 0.01 \
    -m outputs/dining_chair/irgs --train_ray

CUDA_VISIBLE_DEVICES=0 python render.py \
    -m outputs/dining_chair/irgs \
