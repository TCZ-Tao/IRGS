...
# jugs
CUDA_VISIBLE_DEVICES=3 python train_refgaussian.py \
    -s ~/data/Synthetic4Relight/jugs \
    -m outputs/Synthetic4Relight/jugs/refgs \
    --eval -w --lambda_mask_entropy 0.05

CUDA_VISIBLE_DEVICES=3 python train.py \
    -s ~/data/Synthetic4Relight/jugs \
    --eval --iterations 20000 \
    --start_checkpoint_refgs outputs/Synthetic4Relight/jugs/refgs/chkpnt50000.pth \
    --envmap_resolution 128 \
    --lambda_base_color_smooth 2 \
    --lambda_roughness_smooth 2 \
    --diffuse_sample_num 256 \
    ...
    --init_roughness_value 0.6 \
    --lambda_light 0.01 \
    -m outputs/Synthetic4Relight/jugs/irgs --train_ray

CUDA_VISIBLE_DEVICES=3 python render.py \
    -m outputs/Synthetic4Relight/jugs/irgs \
    --eval --diffuse_sample_num 512 \
    --no_save --no_lpips
CUDA_VISIBLE_DEVICES=3 python compute_albedo_scale_syn4.py \
    -m outputs/Synthetic4Relight/jugs/irgs
CUDA_VISIBLE_DEVICES=3 python eval_material_syn4.py \
    -m outputs/Synthetic4Relight/jugs/irgs \
    --no_save --no_lpips --albedo_rescale 2
